...
are ready to release a package for the first time with Melos use [manual versioning](/guides/automated-releases#manual-versioning). This will ensure that the version increment is
