...
Manually specify a version for a package. Can be used multiple times. Each value must be in the format "package:version". Cannot be combined with --graduate or --prerelease flag.
