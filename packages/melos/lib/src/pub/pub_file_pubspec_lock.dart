...
class PubspecLockPubFile extends PubFile {
  ...
  String toString() {
    ...
    // 'pub' uses a regex to extract some version information.
    // Because [toYamlString] adds a trailing space, this breaks the regex; so
    // here we remove any trailing spaces on lines ending with a colon ":".
    //
    // Issue: https://github.com/invertase/melos/issues/36
    // Regex test: https://regex101.com/r/grIyGW/1
    return string.replaceAll(RegExp(r':\s$', multiLine: true), ':');
  }
}
